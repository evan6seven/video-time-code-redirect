...
The repo also includes a Tampermonkey userscript version at [tampermonkey.user.js](https://github.com/evan6seven/video-time-code-redirect/blob/main/tampermonkey.user.js).
...
- Uses `browser.storage.local` in the Firefox extension and Tampermonkey script storage in the userscript
